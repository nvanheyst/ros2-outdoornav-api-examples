...
| `delete_all.py` | `mission_manager/{delete_all, get_all_maps, get_all_missions, get_all_points_of_interest}` | Wipe every map, mission, POI - cleanup after these examples litter the UI. `--dry-run` lists counts; `--confirm` fires. |
